...
class LowerAdministration:
    def __init__(self, root):
        ...
        cam1 = Label(floorFrame, text="Coridor Cam video", cursor="hand2", bg="white", fg="#097179",
                               font=("times new roman", 20, "bold")).place(x=250, y=150, width=400, height=400)

        cam2 = Label(floorFrame, text="Main Hall Cam video", cursor="hand2", bg="white", fg="#097179",
                               font=("times new roman", 20, "bold")).place(x=750, y=150, width=400, height=400)
