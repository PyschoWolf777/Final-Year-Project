...
class Users:
    def __init__(self, root):
        ...
        addHighManagerButton = Button(settingFrame, text="Higher Manager", cursor="hand2", bg="#097179", fg="white",
                               font=("times new roman", 20, "bold"), bd=4).place(x=450, y=150, width=500, height=150)

        addLowerManagerButton = Button(settingFrame, text="Lower Manager", cursor="hand2", bg="#097179", fg="white",
                               font=("times new roman", 20, "bold"), bd=4).place(x=450, y=370, width=500, height=150)
