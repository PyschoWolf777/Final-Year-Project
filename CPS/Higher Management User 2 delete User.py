...
class UserMain:
    def __init__(self, root):
        ...
        addManager = Button(addManagerFrame, text="Remove Manager", cursor="hand2", bg="#097179", fg="white",
                                      font=("times new roman", 20, "bold"), bd=4).place(x=450, y=150, width=500,
                                                                                        height=150)

        removeManager = Button(addManagerFrame, text="Add Manager", cursor="hand2", bg="#097179", fg="white",
                                       font=("times new roman", 20, "bold"), bd=4).place(x=450, y=370, width=500,
                                                                                         height=150)
