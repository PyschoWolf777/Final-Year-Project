...
class Notification:
    def __init__(self, root):
        ...
        notfi1 = Label(floorFrame, text="Notification 1", cursor="hand2", bg="white", fg="#097179",
                               font=("times new roman", 20, "bold")).place(x=300, y=150, width=800, height=70)

        notfi2 = Label(floorFrame, text="Notification 2", cursor="hand2", bg="white", fg="#097179",
                       font=("times new roman", 20, "bold")).place(x=300, y=250, width=800, height=70)

        notfi3 = Label(floorFrame, text="Notification 3", cursor="hand2", bg="white", fg="#097179",
                       font=("times new roman", 20, "bold")).place(x=300, y=350, width=800, height=70)

        notfi4 = Label(floorFrame, text="Notification 4", cursor="hand2", bg="white", fg="#097179",
                       font=("times new roman", 20, "bold")).place(x=300, y=450, width=800, height=70)
